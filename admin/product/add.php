...
$id = $title = $price = $num = $thumbnail = $content = $id_category = "";
if (!empty($_POST['title'])) {
    ...
    if (!empty($title)) {
        ...
        if ($id == '') {
            // Thêm danh mục
            $sql = 'insert into product(title, price, num, thumbnail, content, id_category) 
            values ("' . $title . '","' . $price . '","' . $num . '","' . $target_file . '","' . $content . '","' . $id_category . '")';
        } else {
            // Sửa danh mục
            $sql = 'update product set title="' . $title . '",price="' . $price . '",num="' . $num . '",thumbnail="' . $target_file . '",content="' . $content . '",id_category="' . $id_category . '" where id=' . $id;
        }
        execute($sql);
            ...
            <div class="panel-body">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input required="true" type="num" class="form-control" id="num" name="num" value="<?= $num ?>">
                    </div>
                    <div class="form-group">
