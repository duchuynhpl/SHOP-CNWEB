                    ...
                    <table>
                        ...
                        <?php
                            try {
                                ...
                                $sql = "SELECT *,order_details.num as numdetails from orders, order_details, product
                                ...
                                foreach ($order_details_List as $item) {
                                    echo '
                                        <tr style="text-align: center;">
                                            <td>' . (++$count) . '</td>
                                            <td>' . $item['fullname'] . '</td>
                                            <td>' . $item['title'] . '<br>(<strong>' . $item['numdetails'] . '</strong>)</td>
                                            <td class="b-500 red">' . number_format($item['numdetails'] * $item['price'], 0, ',', '.') . '<span> VNĐ</span></td>
                                            <td>' . $item['address'] . '</td>
                                            <td class="b-500">' . $item['phone'] . '</td>
                                        </tr>
                                    ';
                                }
                            } catch (Exception $e) {
